            ...
            <div class="container">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $categories[3]->name }}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($categories[3]->posts()->orderBy('created_at', 'desc')->take(-1)->get() as $post)
                ...
                <div class="padded-50"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $categories[2]->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($categories[2]->posts()->orderBy('created_at', 'desc')->take(-1)->get() as $post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $post->featured }}" alt="our case">
