        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s">
                    <a href="#"><img src="{{ $posts[0]->featured }}" alt="{{ $posts[0]->title }}"></a>
                    <div class="post-style2-detail">
                        <h3><a href="{{ route('category.single', ['id' => $posts[0]->category->id ]) }}" title="">{{ $posts[0]->title }}</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="images/comment-01.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>{{ $posts[0]->category->name }}</span></a> --</li>
                                <li><a title="" href="">{{ $posts[0]->created_at->toFormattedDateString() }}</a> --</li>
                                <li><a title="" href="#"><span>0 Comment</span></a></li>
                            </ul>
                        </div>
                        <p>{{ route('post.single', ['slug' => $posts[0]->slug ]) }}</p>
                        <button type="button" class="btn btn-style"><a href="{{ route('category.single', ['id' => $posts[0]->category->id ]) }}">Read more</a></button>
                    </div>
                </div>
                @endisset
                <!--Post list-->
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <a href="#"><img src="{{ $posts[1]->featured }}" alt="{{ $posts[1]->title }}"></a>
                    <div class="post-style2-detail">
                        <h3><a href="{{ route('category.single', ['id' => $posts[1]->category->id ]) }}" title="">{{ $posts[1]->title }}</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="images/comment-02.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>{{ $posts[1]->category->name }}</span></a> --</li>
                                <li><a title="" href="#">{{ $posts[1]->created_at->toFormattedDateString() }}</a> --</li>
                                <li><a title="" href="#"><span>0 Comment</span></a></li>
                            </ul>
                        </div>
                        <p>{{ route('post.single', ['slug' => $posts[1]->slug ]) }}</p>
                        <button type="button" class="btn btn-style"><a href="{{ route('category.single', ['id' => $posts[1]->category->id ]) }}">Read more</a></button>
                    </div>
                </div>
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <a href="#"><img src="{{ $posts[2]->featured }}" alt="{{$posts[2]->title  }}"></a>
                    <div class="post-style2-detail">
                        <h3><a href="{{ route('category.single', ['id' => $posts[2]->category->id ]) }}" title="">{{ $posts[2]->title }}</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="images/comment-01.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>{{ $posts[2]->category->name }}</span></a> --</li>
                                <li><a title="" href="#">{{ $posts[2]->created_at->toFormattedDateString() }}</a> --</li>
                                <li><a title="" href="#"><span>0 Comments</span></a></li>
                            </ul>
                        </div>
                        <p>{{ route('post.single', ['slug' => $posts[2]->slug ]) }}</p>
                        <button type="button" class="btn btn-style"><a href="{{ route('category.single', ['id' => $posts[2]->category->id ]) }}">Read more</a></button>    
                    </div>
                </div>
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                    <a href="#"><img src="{{ $posts[3]->featured }}" alt="{{ $posts[3]->title }}"></a>
                    <div class="post-style2-detail">
                        <h3><a href="{{ route('category.single', ['id' => $posts[3]->category->id ]) }}" title="">{{ $posts[3]->title }}</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="images/comment-02.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>{{ $posts[3]->category->name }}</span></a> --</li>
                                <li><a title="" href="#">{{ $posts[3]->created_at->toFormattedDateString() }}</a> --</li>
                                <li><a title="" href="#"><span>0 Comments</span></a></li>
                            </ul>
                        </div>
                        <p>{{ route('post.single', ['slug' => $posts[3]->slug ]) }}</p>
                        <button type="button" class="btn btn-style"><a href="{{ route('category.single', ['id' => $posts[3]->category->id ]) }}">Read more</a></button>
                    </div>
                </div>
                ...
                @isset($posts[4])
                <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                    <a href="#"><img src="{{ $posts[4]->featured }}" alt="{{ $posts[4]->title }}"></a>
                    <div class="post-style2-detail">
                        <h3><a href="{{ route('category.single', ['id' => $posts[4]->category->id ]) }}" title="">{{ $posts[4]->title }}</a></h3>
                        <div class="date">
                            <ul>
                                <li><img src="images/comment-02.jpg" class="img-responsive" alt=""></li>
                                <li>By <a title="" href="#"><span>{{ $posts[4]->category->name }}</span></a> --</li>
                                <li><a title="" href="#">{{ $posts[4]->created_at->toFormattedDateString() }}</a> --</li>
                                <li><a title="" href="#"><span>0 Comments</span></a></li>
                            </ul>
                        </div>
                        <p>{{ route('post.single', ['slug' => $posts[4]->slug ]) }}</p>
                        <button type="button" class="btn btn-style"><a href="{{ route('category.single', ['id' => $posts[4]->category->id ]) }}">Read more</a></button>
                    </div>
                </div>
